...
export const DEF_CONVERTER = {type: constants.CONVERTER, url: "converters"};
...
export const DEF_ANALYZER = {type: constants.ANALYZER, url: "analyzers"};
export const DEF_FLOW = {type: constants.FLOW, url: "filterflows"};
export const DEF_METAMORPHER = {type: constants.METAMORPHER, url: "metamorphers"};
...
export const DEF_LINEROI = {type: constants.LINEROI, url: "linerois"};
