...
import type {BioConverterStavanger, BioSeriesCollectorStavanger} from "./index";
...
const mapStavangerToProps = (stavanger: BioSeriesCollectorStavanger) => ({
    list: stavanger.bioserieslist.selectors.getModel,
});

const mapStavangerToDispatch  = (stavanger: BioSeriesCollectorStavanger) =>  ({
    selectItem: (item) => stavanger.bioserieslist.model.selectItem.request(item),
    deleteItem: (item) => stavanger.bioserieslist.model.deleteItem.request(item)
});
