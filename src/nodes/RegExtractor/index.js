...
export type  RegExtractorStavanger = Stavanger &{
...
export const regExtractorStavanger = createStavanger({
...
export default connectOpera(regExtractorStavanger)(orchestraterEpic)(ExperimentAdder);