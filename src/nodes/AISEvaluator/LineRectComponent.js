...
import type {AISEvaluatorStavanger} from "./index";
...
const mapStavangerToProps = (stavanger: AISEvaluatorStavanger) => ({
    repin: stavanger.representation.selectors.getData
});

const mapStavangerToDispatch  = (stavanger: AISEvaluatorStavanger) =>  ({
});
