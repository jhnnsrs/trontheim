...
export const parserConductor = (nodeStavanger: EdgeStavanger, configuration: ParserConfiguration): Epic  => {
    /**
    ...
    const onModelInPostParsing = (action$, state$) =>
        action$.pipe(
    ...
    return combineEpics(onModelInPostParsing,onPageStartedListenToOutput,onOutPutForwarder)
}