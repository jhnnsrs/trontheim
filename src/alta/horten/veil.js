...
export type HortenVeilModel = HortenModel & {
...
export type HortenVeilSelectors = HortenSelectors & {
    getCurrentAuth: HaldenSelector,
    getJoinedRooms: HaldenSelector
}

export type HortenVeilHelpers = HortenHelpers
...
export type HortenVeil = {
    model: HortenVeilModel,
    selectors: HortenVeilSelectors,
    helpers: HortenVeilHelpers,
...
export const createHortenVeilModel = createHortenModel({
...
export const createHortenVeilHelpers = createHortenHelpers()

export const createHordenVeilSelectors = createHortenSelectors({
...
export const createHortenVeilEpic = createHortenEpic((model: HortenVeilModel, selectors: HortenVeilSelectors) => ({
...
export const createHortenOsloReducer = createHortenReducer((model: HortenVeilModel) => (
    {
...
export function createHortenVeil(definition: HortenVeilDefinition): ((Alias) => HortenVeil) {
    let modelCreator = createHortenVeilModel;
    let selectorsCreator = createHordenVeilSelectors;
    let helperCreator = createHortenVeilHelpers;
    let epicCreator = createHortenVeilEpic;
