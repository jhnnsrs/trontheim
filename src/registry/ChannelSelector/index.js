...
export type  ChannelSelector = NodeStavanger &{
...
export const ports = {
    ...
    outs: [
        {name: "channel", type: constants.ZARR_CHANNEL}
    ]
}
...
export const zarrChannelSelector = createStavanger({
    ...nodeConductor,
...
export default connectOpera(zarrChannelSelector)(orchestraterEpic)(ImageMutater);