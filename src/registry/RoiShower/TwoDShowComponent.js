                            ...
                            return (
                                ...
                                >
                                    <svg width={shape[0]} height={shape[1]}>
                                        ...
                                        {roi.data &&  <LineRoi key={roi.data.id} roi={roi}/>}
...
export const mapStavangerToProps = (stavanger: RoiShowerStavanger) => {
...
export const mapStavangerToDispatch = (stavanger: RoiShowerStavanger) => ({
